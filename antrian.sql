...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 17, 2021 at 12:16 PM
...
(2, 'admin', 'wasd2454', 'admin', 1, 'default.png', 'sb_admin');
...
(31, 0, 15, 1, '1', '2021-01-17'),
(32, 0, 15, 1, '2', '2021-01-17'),
(33, 0, 15, 1, '3', '2021-01-17'),
(34, 0, 15, 1, '4', '2021-01-17'),
(35, 0, 16, 1, '5', '2021-01-17'),
(36, 0, 16, 1, '6', '2021-01-17'),
(37, 0, 16, 1, '7', '2021-01-17');
...
(1, 'PNSK', 'Pengambilan Surat Kesehatan', '30');
...
(15, '23123212', 'T.Umar Adil P', 'Laki-Laki', '2021-01-14', 'Jl.Giam Raya B7 No.18', '08123123123123', 'adil21@gmail.com', '94aa7a0918b0deba36083f7d06e7f43d'),
(16, '3123123123', 'Jayna Proudmoore', 'Perempuan', '2021-01-08', 'Kul Tiras', '010101010101010', 'jayna21@gmail.com', '94aa7a0918b0deba36083f7d06e7f43d');
...
--
ALTER TABLE `antrian`
  MODIFY `id_antrian` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `antrian_poli`
--
ALTER TABLE `antrian_poli`
  MODIFY `id_antrian_poli` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
